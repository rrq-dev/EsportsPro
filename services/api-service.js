...
export const apiService = {
  ...
  getTournamentById: async (id) => {
    try {
      ...
      if (!response.ok) throw new Error(`Failed to fetch tournament with id ${id}`)
      return await response.json()
    } catch (error) {
  ...
  updateTournament: async (id, data) => {
    try {
      ...
      if (!response.ok) throw new Error(`Failed to update tournament with id ${id}`)
      return await response.json()
    } catch (error) {
  ...
  deleteTournament: async (id) => {
    try {
      ...
      if (!response.ok) throw new Error(`Failed to delete tournament with id ${id}`)
      return await response.json()
    } catch (error) {
  ...
  updatePlayer: async (id, data) => {
    try {
      ...
      if (!response.ok) throw new Error(`Failed to update player with id ${id}`)
      return await response.json()
    } catch (error) {
  ...
  deletePlayer: async (id) => {
    try {
      ...
      if (!response.ok) throw new Error(`Failed to delete player with id ${id}`)
      return await response.json()
    } catch (error) {
  ...
  getUserOrders: async (userId) => {
    try {
      ...
      if (!response.ok) throw new Error(`Failed to fetch orders for user ${userId}`)
      return await response.json()
    } catch (error) {
